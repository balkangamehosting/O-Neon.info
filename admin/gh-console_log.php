...
$text = "<pre>Console Data (<a href='gh-console_log.php?id=$serverid'>Click to Refresh</a>) - Last 1000 lines<hr>";
$text .= htmlspecialchars($result_info);
$text .= "<hr>Console Data (<a href='gh-console_log.php?id=$serverid'>Click to Refresh</a>) - Last 1000 lines</pre>";
exit($text);

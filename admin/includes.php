...
function srvgrafik($ip, $port) {
	...
	$grafik = '<span class="autor" data-selector="true" data-content="<img src=\'../grafik/'.$ipport.'.png\' />" style="color: #95A1AB">' . $ip . ':<m>' . $port . '</m></span>';

...
?>
		...
		<li>
				<a href="#">
					<img alt="" src="<?php echo user_avatar($kid); ?>" class="media-object thumb-sm img-circle" style="width:25px;height:auto;"> <span style="color:#0ba3fd;"><?php echo user_imesl($kid); ?></span>				</a> 
				<i class="fa fa-caret-right"></i>
			</li>
			<li><strong><?php echo $row['Text']; ?></strong></li>
		</div>
...
<a href="#">
					<img alt="" src="<?php echo admin_avatar($row['admin_id']); ?>" class="media-object thumb-sm img-circle" style="width:25px;height:auto;"> <span style="color:#0ba3fd;"><?php echo admin_ime_l($row['admin_id']); ?></span>				</a> 
				<i class="fa fa-caret-right"></i>
			</li>
			<li><strong><?php echo $row['Text']; ?></strong></li>
			</div>
...
?>
		<li style="width:100%;">
			...
			<img src="<?php echo admin_avatar($row['id']); ?>" class="media-object thumb-sm img-circle" style="width:25px;height:auto;" />
			</div>
			<div class="news-item-detail">				

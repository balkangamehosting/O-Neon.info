	...
	break;
      ...
      case'rcon':
            ...
            if($server['igra'] == "1")
            {
                ...
                include '/var/zpanel/hostdata/etrail/public_html/e-traill_us/includes/rcon_hl_net.inc';
                $M = new Rcon();
            ...
            {
                //error_reporting(E_ALL);
                require '/var/zpanel/hostdata/etrail/public_html/e-traill_us/includes/libs/SourceQuery/SourceQuery.class.php';

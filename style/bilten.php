<div id="bilten">
	...
	<div id="text_container">
		<h2><span style="color:#0089a6">O-Neon.info</span> Bilten</h2>
		<p>prijavite se na nas bilten i dobijate najnovije informacije vezane za sam hosting...</p>
		<p>Poruke od naseg Biltena <a href="#" data-toggle="modal" data-target="#edit-bilten" style="text-decoration: none;color:#0089a6">možete onemogućiti</a> u bilo kojem trenutku!</p>
	</div>

            ...
            <div id="server_info_infor">
                <div id="server_info_infor2">
                    ...
                    <div class="gp-home">
                        ...
                        <div class="podForm" style="">
                            <?php if (is_pin() == false) { ?>
                                ...
                                <br /> <br />
                                <span style="padding: 5px 10px;background: #076ba6;color: #fff;cursor: pointer;font-size: 12px;font-weight: bold;border: 1px solid #bbb;" data-toggle="modal" data-target="#pin-auth">OTKLJUČAJ
                                </span>
                            <?php } else { ?>
                                <form action="process.php?task=edit_profile" method="POST" autocomplete="off">
                                    ...
                                    <input type="password" name="password" placeholder="Ako ne zelite menjat ostavite prazno polje" style="margin-left: 45px;"> <br />
				    ...
				    <label for="avatar">AVATAR LINK </label>
                                    <input type="text" name="avatar" value="<?php echo $uzmi_usera['avatar']; ?>" style="margin-left: 63px;"> <br />
				    </br>
</br>

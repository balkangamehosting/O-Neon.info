...
$user = mysql_fetch_assoc(mysql_query("SELECT * FROM `klijenti` WHERE `token` = '$Rs_ID'"));
$tokenbaza = $user["token"];
...
if ($Rs_ID == $tokenbaza) {
	...
	$srw_obv_rs = mysql_query("SELECT * FROM `serveri` WHERE `user_id` = '$userid'");
